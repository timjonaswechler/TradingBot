...
pub fn open_paper_position(
    ...
    conn.reducers
        .open_paper_position_then(
            ...
            position.entry_effective_fill_price,
            position.entry_spread_adjustment,
            position.entry_fixed_fee,
            position.entry_percent_fee,
...
pub fn record_paper_position_closed(
    ...
    conn.reducers
        .record_paper_position_closed_then(
            ...
            trade.entry_base_price,
            trade.entry_effective_fill_price,
            trade.entry_spread_adjustment,
            trade.entry_fixed_fee,
            trade.entry_percent_fee,
            trade.entry_total_cost,
            trade.exit_base_price,
            trade.exit_effective_fill_price,
            trade.exit_spread_adjustment,
            trade.exit_fixed_fee,
            trade.exit_percent_fee,

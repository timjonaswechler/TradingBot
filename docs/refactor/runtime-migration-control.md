...
- Do not turn Runtime Events into a persisted event store in V1. The live path should project selected runtime-semantic outputs through a Live Persistence Adapter into existing live persistence records unless a separate accepted decision reopens event sourcing.
